...
import Corrorsel from '../components/Corrorsel.vue'
...
export default {
  ...
  computed: {
    ...mapState(useCampusStore, ['limit', 'campuses', 'countData', 'offsetData','news']),
    ...mapWritableState(useCampusStore, ['numberOfPage'])
  },
  methods: {
    ...mapActions(useCampusStore, ['fecthCampus', 'parseQuery','corousel']),
  ...
  <div class="d-flex flex-column" id="home-section">
    <div class="pt-5 d-flex justify-content-center">
      <section class="col-lg-10 px-md-4" id="product-section">
        ...
        >
          <h1 class="display-2">University</h1>
          <a href="" @click.prevent="goNews"><i class="bi bi-newspaper"></i> NEWS</a>
          <Search />
        </div>
    ...
    <div>
      <div class="row row-cols-1 row-cols-md-4 g-4 m-auto justify-content-around">
        <!-- card -->
        <CardCampus v-for="campus in campuses" :key="campus.id" :campus="campus" type="exam" />
      </div>
    </div>
    <!-- paggination -->
    <div class="container">
